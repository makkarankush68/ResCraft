...
const initialResumeData: ResumeData = {
  personalInfo: {
    ...
    summary: 'Full-stack developer with 5+ years of experience in building responsive web applications and leading engineering teams. Passionate about learning new technologies and improving software scalability and performance.'
  },
  projects: [
    {
